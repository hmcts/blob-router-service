...
import uk.gov.hmcts.reform.blobrouter.launchdarkly.LaunchDarklyClient;
import uk.gov.hmcts.reform.blobrouter.launchdarkly.LaunchDarklyClientFactory;

import static org.assertj.core.api.Assertions.assertThat;
import static uk.gov.hmcts.reform.blobrouter.launchdarkly.Flags.BLOB_ROUTER_SERVICE_TEST;
...
class LaunchDarklyTest {
    ...
    void checkLaunchDarklyTestFlag() {
        Boolean testFeatureBoolean = ldClient.isFeatureEnabled(BLOB_ROUTER_SERVICE_TEST);
